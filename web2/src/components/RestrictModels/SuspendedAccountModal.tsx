    ...
    >
      ...
      >
        ...
        <div className="p-8 text-center">
          ...
          <h2 className="text-2xl font-bold text-[#0e2a47] mb-3">Account Suspended</h2>

          <p className="text-slate-600 text-[15px] leading-relaxed mb-6">
            Your account is suspended, so you cannot {actionName} right now. Contact admin for assistance.
          </p>

          <div className="bg-red-50 rounded-lg p-4 mb-6 space-y-2 text-left">
            <div className="flex items-start gap-3">
              <svg className="w-5 h-5 text-red-500 mt-0.5 shrink-0" viewBox="0 0 24 24" fill="currentColor">
                <path d="M12 2l9 16H3L12 2z" />
              </svg>
              <span className="text-sm text-slate-600">Locking and booking are disabled for suspended accounts</span>
            </div>
            <div className="flex items-start gap-3">
              <svg className="w-5 h-5 text-red-500 mt-0.5 shrink-0" viewBox="0 0 24 24" fill="currentColor">
                <path d="M12 2l9 16H3L12 2z" />
              </svg>
              <span className="text-sm text-slate-600">Please contact the admin team to restore access</span>
            </div>
          </div>

          <button
            onClick={onClose}
            className="w-full px-6 py-3 bg-[#0e2a47] hover:bg-[#16385d] text-white font-bold rounded-xl shadow-lg transition-all active:scale-[0.98]"
          >
            Close
          </button>
        </div>
