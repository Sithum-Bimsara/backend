...
export const MessageSquareIcon = ({ size = 36 }: { size?: number }) => (
...
export const TagIcon = ({ size = 11 }: { size?: number }) => (
...
export const CheckCheckIcon = ({ size = 12, className = "" }: { size?: number, className?: string }) => (
